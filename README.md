...
* Separación de clases y metodos para manejar mejor coherencia en las fuenciones de las clases.
* Implementación de modelo arquitectonico
* Correción del anti-patron "Magic Number".
